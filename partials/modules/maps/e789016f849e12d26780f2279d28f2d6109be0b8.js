...
(function(){
  ...
  .service('mapsService', [
   ...
   function ($q, $firebaseObject, $firebaseArray, $log, authService, $filter) {
     var self = this;
     self.fbMapsUrl = "https://congmap-demo.firebaseio.com/maps/";
     self.fbAddressUrl = "https://congmap-demo.firebaseio.com/addresses/";
     self.fbAssgnUrl = "https://congmap-demo.firebaseio.com/assignedMaps/";
     self.fbActiveMapsUrl = "https://congmap-demo.firebaseio.com/activeMaps";
     self.fbFsgUrl = "https://congmap-demo.firebaseio.com/fsg/";
     self.fbUsersUrl = "https://congmap-demo.firebaseio.com/users/";
     self.fbStatusUrl = "https://congmap-demo.firebaseio.com/status";
